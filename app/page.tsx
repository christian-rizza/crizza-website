    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="text-center py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mb-6 text-foreground">Christian Rizza</h1>
      ...
      <section className="py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <Card className="text-center">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-card-foreground">15+</CardTitle>
              <CardDescription>Years Experience</CardDescription>
            </CardHeader>
          </Card>
          <Card className="text-center">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-card-foreground">50+</CardTitle>
              <CardDescription>Projects Delivered</CardDescription>
            </CardHeader>
          </Card>
          <Card className="text-center">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-card-foreground">12</CardTitle>
